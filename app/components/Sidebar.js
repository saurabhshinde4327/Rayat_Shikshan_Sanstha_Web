...
{/* Magazine */}
          <li className="mb-3">
            <button
              onClick={() => toggleMenu("magazineOpen")}
              className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
            >
              <Settings className="w-5 h-5 mr-2" alt="Notices Icon" /> Rayat Masik
              <ChevronDown
                className={`w-4 h-4 ml-auto transition-transform ${
                  menuState.magazineOpen ? "rotate-180" : ""
                }`}
                alt="Chevron Icon"
              />
            </button>
            {menuState.magazineOpen && (
              <ul className="ml-6 mt-2">
                <li>
                  <button
                     onClick={() => router.push("/addmagazine")}
                    className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
                  >
                    <PlusCircle className="w-4 h-4 mr-2" alt="Add Notice Icon" /> Add  Rayat Masik
                  </button>
                </li>
                <li className="mt-2">
                  <button
                    onClick={() => router.push("/managemagazine")}
                    className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
                  >
                    <ClipboardList className="w-4 h-4 mr-2" alt="Manage Notices Icon" /> Manage  Rayat Masik
                  </button>
                </li>
              </ul>
            )}
...
<li className="mb-3">
            <button
              onClick={() => toggleMenu("scrollingActivitiesOpen")}
              className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
            >
              <Calendar className="w-5 h-5 mr-2" alt="Recent Activities Icon" /> Scrolling News
              <ChevronDown
                className={`w-4 h-4 ml-auto transition-transform ${
                  menuState.scrollingActivitiesOpen ? "rotate-180" : ""
                }`}
                alt="Chevron Icon"
              />
            </button>
            {menuState.scrollingActivitiesOpen && (
              <ul className="ml-6 mt-2">
                <li>
                  <button
                ...
                <li className="mt-2">
                  <button
                   onClick={() => router.push("/managescrollingnews")}
                    className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
                  >
                    <ClipboardList className="w-4 h-4 mr-2" alt="Manage Recent Activities Icon" /> Manage Scrolling News
                  </button>
                </li>
              </ul>
            )}
...
<li className="mb-3">
          ...
          <li className="mb-3">
            <button
              onClick={() => toggleMenu("ebooksOpen")}
              className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
            >
              <Newspaper className="w-5 h-5 mr-2" /> Ebooks
              <ChevronDown
                className={`w-4 h-4 ml-auto transition-transform ${
                  menuState.ebooksOpen ? "rotate-180" : ""
                }`}
              />
            </button>
            {menuState.ebooksOpen && (
              <ul className="ml-6 mt-2">
                <li>
                  <button
                    onClick={() => router.push("/addebooks")}
                    className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
                  >
                    <PlusCircle className="w-4 h-4 mr-2" /> Add Ebooks
                  </button>
                </li>
                <li className="mt-2">
                  <button
                    onClick={() => router.push("/manageebooks")}
                    className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
                  >
                    <ClipboardList className="w-4 h-4 mr-2" /> Manage Ebooks
                  </button>
                </li>
              </ul>
            )}
          ...
          <li className="mb-3">
  <button
    onClick={() => toggleMenu("aiPortalOpen")}
    className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
  >
    <Newspaper className="w-5 h-5 mr-2" /> AI Portal
    <ChevronDown
      className={`w-4 h-4 ml-auto transition-transform ${
        menuState.aiPortalOpen ? "rotate-180" : ""
      }`}
    />
  </button>
  {menuState.aiPortalOpen && (
    <ul className="ml-6 mt-2">
      <li>
        <button
          onClick={() => router.push("/manageaiportal")}
          className="flex items-center p-2 hover:bg-teal-700 rounded w-full text-left"
        >
          <PlusCircle className="w-4 h-4 mr-2" /> Manage AI Report
        </button>
      </li>
