...
export default function RecentActivities() {
  ...
  return (
    <div className="bg-white py-10 px-4 relative z-10"> {/* ✅ Always white */}
      ...
      {selectedImage && (
        <div
          className="fixed inset-0 backdrop-blur-sm bg-black/50 flex justify-center items-center z-50"
