    ...
    <>
      ...
      <div className="w-[95%] max-w-6xl bg-[#E0F2F1] flex flex-col items-center mx-auto shadow-[0_5px_10px_rgba(0,0,0,0.25)] rounded-tl-[80px] rounded-br-[80px] mt-5 mb-5 border-t-[5px] border-b-[5px] border-[#00A99D] p-6">
        ...
        <p className="text-black text-justify p-5 ">
          11 Courses of different kinds are conducted in the 42 Colleges of the
          Sanstha. These include B.A. Course at 27 Colleges, M.A. at 14, B.Com.
          at 25, M.Com. at 9, B.Sc. at 18, M.Sc. at 8, Management 1 B.Ed. 2,
          Professional Courses at 27, Career Oriented Courses at 19, School
          Clusters Courses at 16 in Sanstha’s different Colleges and various
          short-term courses are run so that students of the degree courses like
          B.A., B.Com., B.Sc. should get vocational training.
        </p>
  ...
  const coursesData = [
    ...
    },
    {
      ...
      courses: [
        ...
        "Craft and Art",
        "NCERT, SCERT Bridging",
        "Gurukul Foundation (Std. 6 to Std. 8)",
        "Gurukul Academy (Std. 9 to Std. 12)",
        "Metaschool",
        "Sports and Music Guidance",
        "Next Generation Technological Literacy",
        "Financial Literacy",
        "Online Streaming",
        "STEM Lab",
        "Rayat Culture",
